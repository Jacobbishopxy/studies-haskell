...
\acode{difference}取在第一个集合却不在第二个集合的元素：
...
\acode{null}，\acode{size}，\acode{member}，\acode{empty}，\acode{singleton}，\acode{insert}以及\acode{delete}
函数与预期一致：
